  ...
  return (
    <div className="flex flex-col min-h-dvh bg-background text-foreground">
      ...
      <main className="flex-grow">
        {/* Home Section */}
        <section id="home" className="relative h-dvh flex items-center justify-center text-center px-4">
          ...
          <div className="container max-w-4xl mx-auto text-center">
            ...
            <div className="flex flex-col md:flex-row items-center gap-8 md:gap-12">
              ...
              <div className="text-left space-y-4 text-foreground/90">
                ...
                <p>
                  I hold a Master's degree in Counselling Psychology and am a registered member of the British Association for Counselling and Psychotherapy (BACP). I am committed to continuous professional development to provide the best possible support for my clients.
                </p>
              </div>
            </div>
          </div>
        ...
        <section id="fees" className="py-20 md:py-32 bg-background">
          <div className="container max-w-2xl mx-auto">
            ...
            <p className="text-center mt-6 text-muted-foreground">
              Please contact me to discuss availability or if you have any questions about fees.
            </p>
          </div>
        </section>
...
function ServiceCard({ icon, title, description }: { icon: React.ReactNode, title: string, description: string }) {
  return (
    <Card className="text-center shadow-md hover:shadow-xl transition-shadow duration-300 bg-card">
      <CardHeader>
